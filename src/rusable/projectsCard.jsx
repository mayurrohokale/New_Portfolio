...
export default function ProjectCard({project_name, button_name, date, description, gitLink, webLink, src}) {
  return (
    <div className="flex justify-center">
      <div className="border-[1px] m-2 pb-6 p-2 rounded-lg shadow-lg font-poppins max-w-[310px]">
        ...
        <div>
          ...
          <div className="">
            <div className="flex justify-between">
              <button className="text-sm bg-green-500 text-white px-3 py-1 rounded-sm">
                {button_name}
              </button>
